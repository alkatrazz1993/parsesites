...
<html lang="en">
    <head>
        ...
        <title>Результаты последней проверки в Yandex | findmyinfo</title>
        ...
        <div align="center" class="col-sm-12">
                ...
                <div class="revealator-slideup revealator-once">
                    <div id="headerpd" style="border-radius:10px;border:2px solid #0c235a;text-align:center;font-weight:bold;padding:5px;">
                        <p style="margin:0px;" colspan="2">Результаты последней проверки в <span style="color:#00897b;font-weight:bold;">Yandex</span> <span style="color:#FFAB00"><?=$datausers[0]["last_update"]?></span>:</p>
                    </div>
