...
<html lang="en">
    <head>
        ...
        <title>Поиск данных в yandex | findmyinfo</title>
    ...
    <body id="body">
        ...
        <div class="revealator-slideup revealator-once">
            ...
            <div class="revealator-slideup revealator-once">
                <h1 align="center" class="form-signin-heading">Поиск данных в <span style="color:#00897b;font-weight:bold;">Yandex</span></h1>
                ...
                <?}?> 
                    ...
                    if(!empty($info_search)){
                        foreach($info_search as $key => $param)
				        {
                            ...
                            <?} else if($info_search_output[$key][0] == 'Нет интернет соединения'){?>
                            ...
                            <?}?>
                                <div>
                                    ...
                                    <?if(!empty($info_search_output[$key])){if($info_search_output[$key][0] != 'Список ресурсов пуст' && $info_search_output[$key][0] != 'Нет интернет соединения'){
